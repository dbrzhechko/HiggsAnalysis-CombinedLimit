//---------------------------------------------------------------------------
#ifndef HiggsAnalysis_CombinedLimit_RooDijet5ParamSilvioPdf_h
#define HiggsAnalysis_CombinedLimit_RooDijet5ParamSilvioPdf_h
//---------------------------------------------------------------------------
#include "RooAbsPdf.h"
...
//---------------------------------------------------------------------------
class RooDijet5ParamSilvioPdf : public RooAbsPdf
{
public:
   RooDijet5ParamSilvioPdf() {} ;
   RooDijet5ParamSilvioPdf(const char *name, const char *title,
   ...
   RooDijet5ParamSilvioPdf(const char *name, const char *title,
		  ...
		  RooAbsReal& _p2, RooAbsReal& _p3, RooAbsReal& _p4,
		  RooAbsReal& _sqrts);
   RooDijet5ParamSilvioPdf(const RooDijet5ParamSilvioPdf& other,
      const char* name = 0);
   void setTH1Binning(TH1* _Hnominal);
   void setAbsTol(double _absTol);
   void setRelTol(double _relTol);
   virtual TObject* clone(const char* newname) const { return new RooDijet5ParamSilvioPdf(*this,newname); }
   inline virtual ~RooDijet5ParamSilvioPdf() { }
...
private:
   ClassDef(RooDijet5ParamSilvioPdf,1) // RazorDijet5ParamPolyExtBinPdf function
...
class Dijet5ParamSilvioFunction: public ROOT::Math::IParametricFunctionOneDim
{
private:
   const double *pars;
...
//     double pdf = exp(-pars[2]*(x/pars[0])  + pars[4]*pow(x/pars[0],2) )/pow(x/pars[0],pars[1])  / (exp(1/TMath::Max(x-pars[3],1e-9))-1);
   ...
   {
      return new Dijet5ParamSilvioFunction();
   }
